...
use Kaasu\Http\JsonResponse;
use Kaasu\Http\RpcClient;

/**
 * Wrapper for Kaasu's kaasud JSON-RPC interface.
 * @package Kaasu
 */
class kaasud extends RpcClient
{
    /** @var int */
    protected $rpcPort = 10112;
     ...
     * @param string $address     Valid Kaasu wallet address. Required.
     * @return JsonResponse
     */
